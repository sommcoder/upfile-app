 ...
 Please reload page`),
      ...
      if (e.ok) {
        ...
        console.log("data:", t),
          ...
          (this.MAX_FILE_COUNT = t.maxFileCount),
  ...
  async postFiles(e) {
    try {
      ...
      t.forEach((s, l) => {
        this.prepareForFileUpload(s, l, i);
      });
      ...
      if (r.ok) {
        ...
        console.log("data:", s),
          s.forEach(({ value: l, status: o }) => {
            this.handleFileAdd(l, o);
          });
      }
    } catch (t) {
  ...
  handleFileAdd(e, t) {
    this.renderFileViewerItem(this.fileStateObj[e.id]),
      this.updateFileStatus(e.id, t) &&
        (this.addVariantProps(e.id), this.updateTallyElementText());
  }
  handleFileDelete(e) {
  ...
  handleDragLeave(e) {
    e.preventDefault(), this.resetDragUI();
  }
  handleDrop(e) {
    e.preventDefault(),
      e.stopPropagation(),
